...
<template>
  ...
  <article>
    <div class="card">
      ...
      <div class="title">
        <form action="" class="profession">
          <div class="form-group">
            <input type="text" class="input" required id="profession"/>
      ...
      <div class="actions">
        <div class="follow-info">
          <h2 class="counter"><a><span>12</span><small>Appunti</small></a></h2>
        </div>
        <div class="follow-btn">
          <button>Disconnetti</button>
        </div>
      </div>
    </div>
    <div class="animation">
